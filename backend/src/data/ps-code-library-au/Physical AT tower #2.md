...
This logical unit calculates offsets for the 'Physical AT tower #2' unit yields.
Read the stream Rates, Services, Properties and Compositions from the unit 'Physical AT tower #2'.
