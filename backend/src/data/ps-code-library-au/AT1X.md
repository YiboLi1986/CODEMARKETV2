...
// This logical unit calculates swings ('Physical AT tower #1-S03', 'Physical AT tower #1-S13', 'Physical AT tower #1-S33', 'Physical AT tower #1-S43', 'AT#1-MGO/LVD SWING Pre-Offset') for crude unit 'Physical AT tower #1'.
// Original streams (list) from the 'Physical AT tower #1' unit are written to variables.
// The parameter values entered by users on the 'AT1X' unit are also read to variables.
// The calculation result is updating the splitter parameters ('Splitter LSRN-SRN1', 'Splitter SRN-STOVE1', 'Splitter ST-DIESEL1', 'Splitter DIESEL-MGO1', 'MGO/LVD1 Splitter'). Each splitter divides the original stream into 2 streams and going Up or Down. Splitter accepting values in percentages: 0-100%.
// The final products from 'Physical AT tower #1' are combining in the mixers ('Mixer LSRN1', 'Mixer SRN1', 'Mixer STOVE1', 'Mixer DIESEL1', 'MGO1 Swing Mixer', 'LVD1 Swing Mixer').
